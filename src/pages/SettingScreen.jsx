...
const SettingScreen = () => {
    const [settingText, setHandle] = useState(false);
        ...
        <div>
            ...
            <div className="flex w-[1000px] ">
                <div class="flex items-center w-[150px]">
                    <input id="inline-radio" type="radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
            ...
            <div className="md:w-2/3 pt-5">
                <button type="button" class="text-black hover:text-white border border-gray-800 hover:bg-gray-900  font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 ">
                    変更
                </button>
            </div>
        </div >
    ...
    (
        <div>
            <div className="w-[300px]">
                <label className=" text-gray-500 font-bold mb-1 md:mb-2 pr-4">
                    メールアドレス
                </label>
            </div>
            ...
            <div className="md:w-1/3">
                <label className="block text-gray-500 font-bold mb-1 md:mb-2 pr-4" for="inline-password">
                    パスワード
                </label>
            </div>
            <div className="flex">
                ...
                <div className="md:w-2/3 pl-10">
                    <button type="button" class="text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900  font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 ">
                        変更
                    </button>
                </div>
            ...
            <div className="flex w-[1300px] h-[700px]">
                <div className="flex-none w-[100px] h-[100px] text-sm" >
                    <div className="flex items-center justify-center w-[100px] h-[50px]">
                        <button onClick={settingHandle1}>一般設定</button>
                    </div>
                    <div className="flex items-center justify-center w-[100px] h-[50px]">
                        <button onClick={settingHandle2}>アカウント設定</button>
                    </div>
                </div>
                <div className="flex  justify-left w-[1200px] h-[700px] border-l pt-3 pl-10" >
                    {settingText ? < Text1 /> : <Text2 />}
                </div>
            </div>
        </div>
    );
